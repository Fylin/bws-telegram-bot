...
async function checkJobs() {
   try {
      ...
      // Czekamy na pojawienie się paginacji
      await page.waitForSelector('p.MuiTypography-body2.MuiTablePagination-caption', { timeout: 10000 });

      const countText = await page.$$eval(
         'p.MuiTypography-body2.MuiTablePagination-caption',
